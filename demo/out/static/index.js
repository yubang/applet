// 这里填充每一个页面的数据（一个字典）
var html_and_css_and_js_data = {"/404": {"title": "\u5c0f\u7a0b\u5e8f\u9996\u9875", "html": "\u4f3c\u4e4e\u4f60\u8bbf\u95ee\u4e86\u4e00\u4e2a\u9519\u8bef\u9875\u9762\uff01", "css": "", "js": "app.init({});"}, "/abc": {"title": "\u5c0f\u7a0b\u5e8f\u9996\u9875", "html": "123abc\n<app-test v-bind:t=\"t\"></app-test>123", "css": "", "js": "app.init({\n        \"data\": {t: \"\u6d4b\u8bd5\u6765\u7684\"},\n        \"api\": {\n            \"url\": \"/api\",\n            success: function(d){return {t: d['data']}},\n            method: \"GET\"\n        }\n    });\n    console.log(\"welcome\");"}, "/debug": {"title": "\u5c0f\u7a0b\u5e8f\u9996\u9875", "html": "", "css": "", "js": "app.init({})"}};
